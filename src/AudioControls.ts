...
export class AudioControls implements HUDElement {
  ...
  constructor() {
    ...
    document.querySelector('canvas')!.addEventListener('click', ev => {
      if (ev.offsetX > 30 && ev.offsetX < 55 && ev.offsetY > 10 && ev.offsetY < 35) this.sfxIsMuted = !this.sfxIsMuted;
      if (ev.offsetX > 10 && ev.offsetX < 35 && ev.offsetY > 30 && ev.offsetY < 55) this.musicIsMuted = !this.musicIsMuted;
    })
  }
